...
<footer>
    <div class="bg-gray-800 py-4 text-gray-400 relative z-[1000]">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 my-4 w-full xl:w-1/5">
            <div  class="block w-56 mb-10">
            <a href="/" class="footer__logo">
                    <span class="logo primary"></span>
                </a>
            </div>
            <p class="text-justify">
             Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum ducimus consequuntur doloremque consequatur sed, laborum voluptas sapiente molestiae quibusdam dignissimos temporibus!</p>
          </div>

          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-green-300">Ishwari Designs LLP</h2>
            </div>
            <ul class="leading-8">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-green-300">Blog</h2>
            </div>
            <ul class="leading-8">
              <li><a href="#" class="hover:text-blue-400">Getting Started With Home Planning</a></li>
              <li><a href="#" class="hover:text-blue-400">What is Home Design</a></li>
              <li><a href="#" class="hover:text-blue-400">How our Designs Can Help Your Productivity?</a></li>
              <li><a href="#" class="hover:text-blue-400">lets Strike a Deal</a></li>
              <li><a href="#" class="hover:text-blue-400">See More</a></li>
            </ul>
          </div>
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-green-300">Connect With Us</h2>
            </div>
    ...
    <div class="bg-green-300 py-4 text-gray-100">
