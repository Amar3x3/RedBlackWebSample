        ...
        <div class="container px-4 mx-auto">
          <div class="-mx-4 flex flex-wrap justify-between">
            <div class="px-4 my-4 w-full xl:w-1/5">
              ...
              <p class="text-justify share-tech">
              laborum voluptas sapiente molestiae quibusdam dignissimos temporibus!</p>
            </div>

            <div class="px-4 my-4 w-full sm:w-auto">
              <div>
                <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-green-300 share-tech">Ishwari Designs LLP</h2>
              </div>
            ...
            <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              <div>
                <h2 class="inline-block text-2xl pb-4 mb-4 border-b-4 border-green-300 share-tech">Connect With Us</h2>
              </div>
